/**
 * Essential Tooling to build v8 for diffrent arch and platform
 * Offering also building for diffrent embedder needs like Chromium, NodeJS, Deno, 
 */

const v8monolith_linux_just = {

}


const v8gen = {
  // depends on https://chromium.googlesource.com/chromium/src/+/main/tools/mb 
  // That is a GYP-GN indipendent build tool used for migration from GYP to GN
